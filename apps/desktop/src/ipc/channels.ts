...
export const FORK_RELEASE_CHECK_CHANNEL = "desktop:fork-release-check";
export const FORK_RELEASE_MERGE_AND_BUILD_CHANNEL = "desktop:fork-release-merge-and-build";
