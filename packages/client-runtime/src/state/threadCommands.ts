...
import {
  ...
  type PinThreadMessageInput,
  type UnpinThreadMessageInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    pinMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:pin-message",
      execute: (input: PinThreadMessageInput) => pinThreadMessage(input),
      scheduler,
      concurrency,
    }),
    unpinMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:unpin-message",
      execute: (input: UnpinThreadMessageInput) => unpinThreadMessage(input),
      scheduler,
      concurrency,
    }),
